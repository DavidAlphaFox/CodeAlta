...
public sealed class ArchitectureGuardrailTests
{
    ...
    public void FrontendCoordinators_DoNotAddUntrackedFireAndForgetTasks()
    {
        ...
        var allowedLegacySites = new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "App/ShellThreadStateCoordinator.cs:275:_ = RestoreStartupThreadHistoryAsync(threadId, cancellationToken);",
            "App/ShellThreadStateCoordinator.cs:284:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:297:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:352:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:354:_ = _ensureThreadHistoryLoadedAsync(thread, CancellationToken.None);",
            "App/ShellThreadStateCoordinator.cs:445:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:482:_ = PersistViewStateAsync();",
            ...
            "App/ThreadRuntimeEventCoordinator.cs:110:_ = ObservePluginAgentEventAsync(thread, agentRuntimeEvent.Event);",
            "App/ThreadRuntimeEventCoordinator.cs:126:_ = ObservePluginAgentEventAsync(thread, @event);",
            "App/ThreadRuntimeEventCoordinator.cs:192:_ = InvalidateProjectFileSearchAsync(thread.WorkingDirectory);",
