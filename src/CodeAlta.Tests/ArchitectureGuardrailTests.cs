...
public sealed class ArchitectureGuardrailTests
{
    ...
    public void FrontendCoordinators_DoNotAddUntrackedFireAndForgetTasks()
    {
        ...
        var allowedLegacySites = new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "App/CodeAltaApp.cs:421:_ = OpenModelProvidersAsync();",
            "App/RuntimeEventPump.cs:34:_pumpTask = Task.Run(",
            "App/ShellThreadStateCoordinator.cs:309:_ = RestoreStartupThreadHistoryAsync(threadId, cancellationToken);",
            "App/ShellThreadStateCoordinator.cs:318:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:331:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:390:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:392:_ = _historyLoader.EnsureThreadHistoryLoadedAsync(thread, CancellationToken.None);",
            "App/ShellThreadStateCoordinator.cs:473:_ = PersistViewStateAsync();",
            "App/ShellThreadStateCoordinator.cs:510:_ = PersistViewStateAsync();",
