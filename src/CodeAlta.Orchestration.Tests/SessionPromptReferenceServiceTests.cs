...
[TestClass]
public sealed class SessionPromptReferenceServiceTests
{
    [TestMethod]
    public async Task ResolveAsync_NormalizesReferencesAndCreatesAttachments()
    {
        ...
        var service = new SessionPromptReferenceService(searchService);
    ...
    {
        var service = new SessionPromptReferenceService(new FakeProjectFileSearchService([]));
