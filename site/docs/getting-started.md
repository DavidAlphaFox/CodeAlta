...
In GitHub repositories, type `#` to search recent issues. The picker accepts numbers or words and inserts Markdown issue links such as `[#18](https://github.com/org/repo/issues/18)`.
